...
# ===== تجهيز الميزات مع حماية KeyError =====
...
st.warning(
    "⚠ التوصيات تعليمية فقط، التداول يحمل مخاطر مالية، استشر مختصاً قبل اتخاذ أي قرار حقيقي."
)
